...
My contribution to the project was mainly on the software side, which included writing Python scripts to turn on/ off the LED and to adjust the LED brightness and writing PHP code to execute the appropriate Python script depending on the user's response to the LED controls.
